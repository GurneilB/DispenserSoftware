...
equip = tk.Checkbutton(controls_frame, text="Press once tips are equipped in their respective places",
...
eject = tk.Checkbutton(controls_frame, text="Press once ejection bowl is equipped",
